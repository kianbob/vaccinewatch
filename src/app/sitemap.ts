...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/analysis/vaccine-schedule-2026`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.9 },
    ...
    { url: `${baseUrl}/tools/reporting-rates`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/tools/signal-detection`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    ...
    { url: `${baseUrl}/side-effects/varicella`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/side-effects/dtap`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/side-effects/hepatitis-a`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/side-effects/meningococcal`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/side-effects/rotavirus`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/vaers-database`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.9 },
    { url: `${baseUrl}/vaccine-deaths`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/myocarditis`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/is-vaers-reliable`, lastModified: new Date(), changeFrequency: 'yearly' as const, priority: 0.8 },
    { url: `${baseUrl}/side-effects/pneumonia`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    ...
    { url: `${baseUrl}/adverse-events`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.9 },
    { url: `${baseUrl}/report-adverse-event`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/vaccine-safety-timeline`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
