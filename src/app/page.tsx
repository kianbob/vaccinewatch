      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/side-effects/covid" className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md hover:border-primary/30 transition-all text-center">
              <div className="font-bold text-gray-900">COVID-19</div>
              <div className="text-xs text-gray-500 mt-1">1.1M+ reports</div>
            </Link>
            <Link href="/side-effects/flu" className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md hover:border-primary/30 transition-all text-center">
              <div className="font-bold text-gray-900">Flu</div>
              <div className="text-xs text-gray-500 mt-1">11 vaccine types</div>
            </Link>
            <Link href="/side-effects/mmr" className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md hover:border-primary/30 transition-all text-center">
              <div className="font-bold text-gray-900">MMR</div>
              <div className="text-xs text-gray-500 mt-1">89K+ reports</div>
            </Link>
            <Link href="/side-effects/hpv" className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md hover:border-primary/30 transition-all text-center">
              <div className="font-bold text-gray-900">HPV</div>
              <div className="text-xs text-gray-500 mt-1">Gardasil data</div>
            </Link>
            <Link href="/side-effects/shingles" className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md hover:border-primary/30 transition-all text-center">
              <div className="font-bold text-gray-900">Shingles</div>
              <div className="text-xs text-gray-500 mt-1">140K+ reports</div>
            </Link>
            <Link href="/side-effects/tdap" className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md hover:border-primary/30 transition-all text-center">
              <div className="font-bold text-gray-900">Tdap</div>
              <div className="text-xs text-gray-500 mt-1">52K+ reports</div>
            </Link>
            <Link href="/side-effects/hepatitis-b" className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md hover:border-primary/30 transition-all text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {[
              ...
              { href: '/guillain-barre', label: 'Guillain-Barré' },
              { href: '/allergic-reaction', label: 'Allergic Reactions' },
              { href: '/fever-after-vaccination', label: 'Fever After Vaccination' },
