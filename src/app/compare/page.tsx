...
export default function ComparePage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <DisclaimerBanner />
      <Breadcrumbs items={[{ label: 'Compare Vaccines' }]} />
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 max-w-3xl">
          Select 2-3 vaccines to compare their VAERS adverse event profiles side by side. 
          See total reports, death rates, hospitalization rates, top symptoms, and yearly trends. 
          Remember that differences in report counts primarily reflect differences in doses administered, 
          not differences in safety.
        </p>
      </div>
