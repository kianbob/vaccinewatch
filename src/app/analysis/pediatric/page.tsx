...
export default function PediatricPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-12">
        <div className="flex items-center justify-between mb-2"><div className="text-xs font-medium text-primary uppercase tracking-wider">6 min read</div><ShareButtons title="Pediatric VAERS Analysis - Children 0-17 - VaccineWatch" /></div>
      ...
      <div className="prose prose-lg max-w-none mb-12">
        ...
        <p>
          As VAERS reporting normalizes following the COVID-19 pandemic surge, the data landscape for pediatric adverse event reporting
        ...
        <p>
          ...
          pediatric adverse event reporting across the full spectrum of vaccine safety surveillance.
        </p>
